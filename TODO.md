...
- [~] **Скрипт:** NPC-диалоги 30 → **64** (покрыты ключевые города/данжи/комнаты). Осталось:
      NPC-реплики в домах-интерьерах и defeat-реплики боссов.
...
- [~] **Menu parity:** курсорная навигация (стрелки/Enter, фокус-кольцо) по всем экранам.
      Осталось: equip flow с превью статов, options (скорость текста), экран Valuables.
