export const BESTIARY_GROUPS = [
  {
    ...
    enemyKeys: ['mottledSpider', 'dodo', 'cragSnake', 'gargoyle', 'giantMantis', 'frostFrog', 'hammerhead', 'ghoul', 'sandman', 'durhamMinotaur', 'tongueValmar'],
  ...
  },
  {
    ...
    enemyKeys: ['hugeCaterpillar', 'bigFoot', 'chameleon', 'dragonoid', 'giantCrab', 'hellHound', 'landCougar', 'gigaMantis', 'twinOgre', 'starMirage', 'skullSnail', 'warpWarrior', 'veinBrain', 'guardian', 'clawsValmar', 'cathedralExecutioner'],
  ...
  },
  {
    ...
    enemyKeys: ['flameToad', 'crimsonClaw', 'clayBird', 'fennyBird', 'manEatingTree', 'salamadile', 'scalyWarrior', 'pitViper', 'desertDiver', 'tarantula', 'brainBat', 'dinoFreezer', 'venomousLarva', 'melficeEcho', 'granasaberWarden', 'valmarMoth', 'immuneCell'],
  ...
  },
  {
    ...
    enemyKeys: ['devil', 'snowLeopard', 'nyarmot', 'evilManeuver', 'dragonKnight', 'valmarMagna', 'killerTree', 'mindEater', 'valmarFly', 'valmarYoung', 'yeti', 'ancientWarrior', 'deathDoberman', 'emeraldBird', 'moonWombSentinel', 'innerShadowRyudo', 'valmarCoreHerald'],
