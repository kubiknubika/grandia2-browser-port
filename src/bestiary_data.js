export const BESTIARY_GROUPS = [
  {
    ...
    enemyKeys: ['mottledSpider', 'cragSnake', 'gargoyle', 'giantMantis', 'frostFrog', 'hammerhead', 'ghoul', 'durhamMinotaur', 'tongueValmar'],
  ...
  },
  {
    ...
    locations: ['Lumir Forest', 'Mirumu', 'Mysterious Fissure', 'St. Heim Mountains', 'Raul Hills', 'Cyrum', 'Underground Plant'],
    enemyKeys: ['hugeCaterpillar', 'giantCrab', 'hellHound', 'landCougar', 'gigaMantis', 'guardian', 'clawsValmar', 'cathedralExecutioner'],
  ...
  },
  {
    ...
    locations: ['Ceceile Reef', 'Garlan Village', 'Grail Mountain', 'Ghoss Forest', 'Nanan Village', 'Great Rift', 'Demon\'s Law'],
    enemyKeys: ['fennyBird', 'manEatingTree', 'salamadile', 'melficeEcho', 'granasaberWarden', 'valmarMoth', 'immuneCell'],
  ...
  },
  {
    ...
    enemyKeys: ['nyarmot', 'evilManeuver', 'dragonKnight', 'valmarMagna', 'killerTree', 'mindEater', 'moonWombSentinel', 'innerShadowRyudo', 'valmarCoreHerald'],
