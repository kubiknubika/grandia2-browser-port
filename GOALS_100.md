...
DoD (частично): `SCRIPT_AUDIT.md` показывает 64 диалога / 65 страниц.
...
Текущее: 6 экранов + **курсорная навигация (стрелки/Enter, фокус-кольцо)** — ✅.
Осталось:
- equip flow с превью статов до/после; **P1**
- options: скорость текста, громкость (заглушка), сброс сохранений; **P2**
- экран «Valuables» (ключевые предметы — Roan's Medal, Book of Sages и т.д.); **P2**

DoD (частично): `MENU_AUDIT.md` обновлён.
